 ...
 * تحديث آخر ظهور وحده.
 *
 * **ولا يستدعيه شيء في المستودعات الستة** — لا الوسيط ولا مسار الاستقبال
 * ولا أيّ منصة. و«آخر ظهور» يُكتب فعلاً في `upsertMember` عند كل دخول،
 * وذلك يكفي: الدخول يقع مرّة في اثنتي عشرة ساعة، وتحديثُه في كل طلب محميّ
 * يكلّف كتابةً في `D1` لكل نقرة مقابل دقّةٍ لا يقرؤها أحد.
 *
 * فهو يبقى مُصدَّراً لمنصةٍ تريد دقّةً أعلى وتقبل ثمنَها — لا لأنه مستعمل.
 * وذِكرُه هنا صريحاً كي لا يُقرأ غيابُ المستدعي على أنه سهوٌ يُصلَح بوصله
 * في الوسيط.
 */
